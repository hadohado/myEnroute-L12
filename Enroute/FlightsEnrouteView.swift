...
struct FlightsEnrouteView: View {
   ...
   // @State var myAirport: Airport
    
    var body: some View {
        NavigationView {
            FlightList(flightSearch)
                .navigationBarItems(leading: flightInternet, trailing: filter)
    ...
    @State private var showFilterFlight = false
    
//    var getFlightFromInternet: some View {
//        Text("getFlight").onTapGesture {
//            print("TICKLE !!!")
//        }
//
////        Button("getFlightFromInt") {
////            self.showFilterFlight = true
////        }.onTapGesture {
////            print("you tickle me !")
////        }
//
//    }
    ...
    var flightInternet: some View {
        Button("flightInternet") {
            self.showFilterFlight = true
        }
        .sheet(isPresented: $showFilterFlight) {
            FilterFlightsInternet(flightSearch: self.$flightSearch, isPresented: self.$showFilterFlight)
